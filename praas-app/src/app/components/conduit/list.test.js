...
describe('Conduit List', () => {
  ...
  it('should have table listing conduits', async () => {
  });

  it('should have headings for list table columns', async () => {
  });

  it('should have action button icons', async () => {
  });

  it.skip('should have pagination', async () => {
  });
});
